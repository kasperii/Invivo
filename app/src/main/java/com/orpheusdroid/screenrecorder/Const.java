...
public class Const {
    ...
    public static final String SCREEN_RECORDING_SKIP = "com.orpheusdroid.screenrecorder.services.action.skiprecording";
    ...
    public static final String SCREEN_RECORDING_RESTART = "com.orpheusdroid.screenrecorder.services.action.restartrecording";
